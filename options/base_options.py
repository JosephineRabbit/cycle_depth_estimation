...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--img_source_file_train', type=str, default='/home/dut-ai/Documents/temp/synthia/train/RGB',
                                 help='training and testing dataset for source domain')
        parser.add_argument('--img_target_file_train', type=str, default='/home/dut-ai/Documents/temp/cityscape/Cityscape/leftImg8bit_trainvaltest/leftImg8bit/RGB_train',
                                 help='training and testing dataser for target domain')
        parser.add_argument('--lab_source_file_train', type=str, default='/home/dut-ai/Documents/temp/synthia/train/label_train',
        ...
        parser.add_argument('--img_source_file_test', type=str, default='/home/dut-ai/Documents/temp/synthia/test/RGB',
                                 help='training and testing dataset for source domain')
        parser.add_argument('--img_target_file_test', type=str, default='/home/dut-ai/Documents/temp/cityscape/Cityscape/leftImg8bit_trainvaltest/leftImg8bit/val/RGB_val',
                                 help='training and testing dataser for target domain')
        parser.add_argument('--lab_source_file_test', type=str, default='/home/dut-ai/Documents/temp/synthia/test/label_test',
                                 help='training label for source domain')
        parser.add_argument('--lab_target_file_test', type=str, default='/home/dut-ai/Documents/temp/cityscape/Cityscape/gtFine_trainvaltest/gtFine/val/label_val',
                                 help='training label for target domain')
        initialized = True
        return parser
