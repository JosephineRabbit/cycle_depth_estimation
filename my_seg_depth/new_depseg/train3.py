...
from my_seg_depth.new_depseg.my_data import dataloader
...
from my_seg_depth.new_depseg.model3 import Seg_Depth
import torch
import itertools
...
if __name__ == '__main__':
    ...
    writer_train = SummaryWriter(log_dir='./summary/12_4dis')
    writer_test = SummaryWriter(log_dir='./summary/12_4dis')
    opt = TrainOptions().parse()
    #opt = TrainOptions().parse()
    dataset_train = dataloader(opt, train_or_test='train')
