...
class CreateDataset(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        img_source = img_source.resize([640, 256], Image.BILINEAR)
        img_target = img_target.resize([640, 256], Image.BILINEAR)
        ...
        depth_source = depth_source.resize([640, 256], Image.BILINEAR)
        ...
        lab_source = lab_source.resize([640, 256], Image.NEAREST)
        lab_target = lab_target.resize([640, 256], Image.NEAREST)
