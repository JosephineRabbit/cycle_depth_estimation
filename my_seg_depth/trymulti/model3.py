...
from my_seg_depth.trymulti import networks2
from my_seg_depth.trymulti.networks2 import init_net, init_weights
...
class Seg_Depth(BaseModel):
    ...
    def initialize(self,opt):
        ...
        self.net_Dis0_en = nn.DataParallel(self.net_Dis0_en)
        self.net_Dis0_en.load_state_dict(torch.load(
            '/home/dut-ai/Documents/temp/code/pytorch-CycleGAN-and-pix2pix/my_seg_depth/trymulti/checkpoints/2scale/iter_24000_net_Dis0_en.pth'))
    ...
    #    self.net_Dis_en.load_state_dict(torch.load(
     #       '/home/dut-ai/Documents/temp/code/pytorch-CycleGAN-and-pix2pix/my_seg_depth/new_depseg/checkpoints/new_seg2dep/'
      #      'iter_60000_net_Dis_en.pth'))
        ...
        '/home/dut-ai/Documents/temp/code/pytorch-CycleGAN-and-pix2pix/my_seg_depth/trymulti/checkpoints/2scale/iter_24000_net_G_1.pth'))
        #self.net_G_1 = nn.DataParallel(self.net_G_1)
        print('1')
        ...
        '/home/dut-ai/Documents/temp/code/pytorch-CycleGAN-and-pix2pix/my_seg_depth/trymulti/checkpoints/2scale/iter_24000_net_G_2.pth'))
        ...
        '/home/dut-ai/Documents/temp/code/pytorch-CycleGAN-and-pix2pix/my_seg_depth/trymulti/checkpoints/2scale/iter_24000_net_Seg_de.pth'))
        # self.net_Seg_de = nn.DataParallel(self.net_Seg_de)
        ...
        self.net_Dep_de.load_state_dict(torch.load(
            ...
            '/checkpoints/2scale/iter_24000_net_Dep_de.pth'))
  ...
  #      #self.net_Dep_de = nn.DataParallel(self.net_Dep_de)
    ...
    #    self.optimizer_D2.zero_grad()
     #   self.optimizer_D3.zero_grad()
        syn_features1 = self.net_G_1(self.syn_img).detach()
        syn_features2=self.net_Seg_de(syn_features1)[1].detach()
        pre_s = self.net_Dis0_en(syn_features2)
        real_features1 = self.net_G_2(self.real_img).detach()
  ...
  #      self.loss_D_syn2 = self.criterionGAN(pre_s2, True)
   #     self.loss_D_syn3 = self.criterionGAN(pre_s3, True)
      ...
      #  pre_r3 = self.net_Dis3_en(real_features1[:, 768:1024, :, :])
        ...
        self.loss_D0 = 0.2*loss_D_real0+ loss_D_syn0
