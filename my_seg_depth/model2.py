...
class Seg_Depth(BaseModel):
    ...
    def initialize(self,opt):
        ...
        self.loss_names=['G1_dis','D_syn',
                         'seg_syn','seg_real','D_real',
                          'dep_syn']
     ...
     #   self.net_Seg_de.load_state_dict(torch.load(
      #      '/home/dut-ai/Documents/temp/code/pytorch-CycleGAN-and-pix2pix/my_seg_depth/checkpoints/new_seg2dep/iter_5000_net_Seg_de.pth'))
       ...
       # ))
        ...
        self.criterionSeg = torch.nn.CrossEntropyLoss(weight,size_average=True, ignore_index=255).cuda()
    ...
    def forward(self):
        ...
        self.real_f2, self.real_inf = self.net_G_2(self.real_img,'R')
        self.real_features1 = self.real_f2[0].detach()
    ...
    def backward_Seg(self):
        ...
        seg_syn_pre = self.net_Seg_de(self.detach_list(syn_f2),syn_inf)
        seg_real_pre = self.net_Seg_de(self.detach_list(self.real_f2), self.real_inf.detach())
