...
class SEG(nn.Module):
    def __init__(self,n_cls):
        ...
        self.trans_4 = nn.Conv2d(1664,1024,1,1)
        self.trans_3 = nn.Conv2d(1280,512,1,1)
        self.trans_2 = nn.Conv2d(512, 256, 1, 1)
        self.trans_1 = nn.Conv2d(256,128,1,1)
        ...
        self.Up.append(DeconvBlock(256 + 128, 256))

        self.Up.append(nn.Conv2d(256 +64 , n_cls, 1, 1))
...
class DEP(nn.Module):
    def __init__(self):
        ...
        self.Up.append(nn.Conv2d(256 + 64, 1, 1, 1))
