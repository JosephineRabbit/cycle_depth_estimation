...
from new_model.utils.layer_factory import conv1x1, conv3x3, CRPBlock,PSPBlock,ATBlock
...
class segd(nn.Module):
    def __init__(self,n_cls,up_scale):
...
if __name__ == '__main__':
    ...
    segd8 = segd(n_cls=40,up_scale=3).cuda()
    ...
    for i,name in enumerate(ori_dict):
        ...
        m += 1
    print(n,m)
    torch.save(G_dict, './my_res101_model.pth')
    print(net)
